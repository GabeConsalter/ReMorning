...
public class MainActivity extends AppCompatActivity
    ...
    private void setUpItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
            ...
            private void init() {
                background = new ColorDrawable(0x3DD2AE);
                xMark = ContextCompat.getDrawable(MainActivity.this, R.drawable.ic_done);
    ...
    private void setUpAnimationDecoratorHelper() {
        mRecyclerView.addItemDecoration(new RecyclerView.ItemDecoration() {
            ...
            private void init() {
                background = new ColorDrawable(getResources().getColor(R.color.taskDone));
                initiated = true;
            }
    ...
    public void initView(){
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.revTasks);
    }
    ...
    static class TestViewHolder extends RecyclerView.ViewHolder {
        ...
        public TestViewHolder(ViewGroup parent) {
            super(LayoutInflater.from(parent.getContext()).inflate(R.layout.tasks_list_item, parent, false));
